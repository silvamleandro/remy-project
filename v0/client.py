...
class FlwrClient(fl.client.NumPyClient):
    ...
    def __init__(self, data_path):
        ...
        self.model = model.create_model(input_dim)
    ...
    def evaluate(self, parameters, config):
        ...
        abnormal_losses = calculate_reconstruction_loss(self.abnormal_data, abnormal_inference)
...
def main():
    ...
    # Start Flower client		
    client = FlwrClient(args.data_path)
    # Start NumPy client
